...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        android.util.Log.d("FacebookContentProvider", "onCreateView");
        ...
        refresher = new SwipeRefreshLayout.OnRefreshListener() {
            @Override public void onRefresh() {
                ...
                AppObservable.bindFragment(MainFragment.this, FacebookObservable.getUploadedPhotos(getActivity()))
                        .doOnNext(p -> {
                            android.util.Log.d("FacebookContentProvider", "user: " + p.getFrom().getName());
                            android.util.Log.d("FacebookContentProvider", "link: " + p.getLink());
                        })
                        .toList()
